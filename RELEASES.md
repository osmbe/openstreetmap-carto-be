...
2. Review the changes in git since the last release with a command like `git log --graph $OLD_VERSION...master` or online at https://github.com/openstreetmap-carto/openstreetmap-carto/compare/$OLD_VERSION...master
