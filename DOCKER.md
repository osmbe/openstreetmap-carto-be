...
* `git clone https://github.com/openstreetmap-carto/openstreetmap-carto.git` to clone openstreetmap-carto repository into a directory on your host system
